...
| `kubernetes` package / old MLflow pip | Use `pip: ["mlflow[kubernetes]>=3.11", ...]` |
| `MLFLOW_TRACKING_TOKEN is required` / 401 / HTML login | Pass Console **user** token; do not use Ray SA + `kubernetes-namespaced` (RHOAIENG-44516) |
